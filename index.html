...
<title>Base Pay — Learn money. Practise it safely.</title>  
<style>  
...
<div id="landing">  
  <div class="landing-hero">  
    ...
    <p class="lead">Base Pay is a risk-free money simulator. Payslips, ISAs, credit, pensions, property — all real UK rules, none of the real stakes.</p>  
  </div>  
...
<div id="app" class="hide">  
  <div class="topbar">  
    <div class="brand"><span class="dot"></span> Base Pay</div>  
...
function saveState(){  
 try{ localStorage.setItem('basePaySave', JSON.stringify(state)); }catch(e){ /* storage unavailable — degrade gracefully */ }  
}  
function loadState(){  
 try{ const raw=localStorage.getItem('basePaySave'); return raw?JSON.parse(raw):null; }catch(e){ return null; }  
}  
function wipeState(){ try{ localStorage.removeItem('basePaySave'); }catch(e){} }  
...
function applyTheme(t){  
 ...
 try{ localStorage.setItem('basePayTheme', t); }catch(e){}  
...
function initTheme(){  
 let t=null;  
 try{ t = localStorage.getItem('basePayTheme'); }catch(e){}  
